...
var _checkbox = __webpack_require__(556);
...
var ToLearn = function (_Component) {
	_inherits(ToLearn, _Component);

	function ToLearn(props, context) {
		_classCallCheck(this, ToLearn);

		var _this = _possibleConstructorReturn(this, (ToLearn.__proto__ || Object.getPrototypeOf(ToLearn)).call(this, props));

		_this.changeStatus = function (ev) {
			var toggleCom = _this.props.toggleCom;
	...
	_createClass(ToLearn, [{
		key: 'componentWillReceiveProps',
		value: function componentWillReceiveProps(nextProps) {
			var todos = nextProps.todo.todos;

			this.setState({
				toLearnData: [].concat(_toConsumableArray(todos))
			});
		}
	}, {
		key: 'componentDidMount',
		value: function componentDidMount() {
			var getTodoList = this.props.getTodoList;
		...
		key: 'handleTodo',
		value: function handleTodo(toLearnData) {
			var _this2 = this;

			return toLearnData && toLearnData.map(function (i, index) {
				return _react2.default.createElement(
					'li',
					{ key: index },
					_react2.default.createElement(_checkbox2.default, { onChange: _this2.changeStatus, itemId: i.id, checked: i.isComplete }),
		...
		value: function render() {
			var toLearnData = this.state.toLearnData;
...
//# sourceMappingURL=6-758961ab418ff6059de5.js.map