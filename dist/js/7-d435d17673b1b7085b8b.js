...
var TodoList = function (_React$Component) {
	...
	_createClass(TodoList, [{
		...
		value: function componentWillReceiveProps(nextProps) {
			var dataList = nextProps.newsPage.dayNewsReducer.dataList;
		...
		value: function componentWillMount() {
			var getDayNewsList = this.props.getDayNewsList;

			var datas = ['张馨予 维权女王', '大兴机场首次试飞', '普京会见美国务卿'];
			getDayNewsList(datas);
		}
	}, {
		key: 'handleRender',
		value: function handleRender() {
			return this.state.dataList.length > 0 && this.state.dataList.map(function (item, i) {
...
//# sourceMappingURL=7-d435d17673b1b7085b8b.js.map