...
var Login = function (_Component) {
	...
	_createClass(Login, [{
		...
		value: function submitHandle() {
			...
			_api2.default.userLogin(this.state).then(function (res) {
				console.log('登陆信息', res);
				_message3.default.success('登陆成功');
				_this2.props.router.push('/blog/list');
			});
		}
	}, {
		key: 'changeValue',
		value: function changeValue(ev, key) {
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'div',
				{ className: 'common-page login-page' },
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(_input2.default, { placeholder: 'username', onChange: function onChange(ev) {
							return _this3.changeValue(ev, 'username');
						} })
				),
				_react2.default.createElement(
					'div',
					...
					_react2.default.createElement(_input2.default, { placeholder: 'password', onChange: function onChange(ev) {
							return _this3.changeValue(ev, 'password');
						} })
				),
				_react2.default.createElement(
					'div',
...
//# sourceMappingURL=8-39c9d1c1c2ba420b7d4f.js.map