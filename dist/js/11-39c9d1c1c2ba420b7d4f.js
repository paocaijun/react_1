...
var BlogDetail = function (_React$Component) {
	...
	_createClass(BlogDetail, [{
		...
		key: 'getBlogDetail',
		value: function getBlogDetail() {
			var _this2 = this;

			var id = this.props.params.id;

			if (!id) return;
			_api2.default.queryBlogDetail({ id: id }).then(function (res) {
				_this2.state.detailMsg = res;
			});
		}
	}, {
		key: 'render',
		value: function render() {
			var msg = [];
			for (var key in this.state.detailMsg) {
				msg.push(_react2.default.createElement(
					'div',
					{ className: 'section', key: key },
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'div',
								{ className: 'author' },
								this.state.detailMsg.author
							),
							_react2.default.createElement(
								'div',
								{ className: 'time' },
								_misc2.default.formatFullDate(this.state.detailMsg.createtime)
							)
						),
						_react2.default.createElement(
							'p',
							{ className: 'content' },
							this.state.detailMsg.content
						)
					)
				)
			);
...
//# sourceMappingURL=11-39c9d1c1c2ba420b7d4f.js.map